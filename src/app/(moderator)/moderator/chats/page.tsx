                    ...
                    <CardHeader>
                        <div className="flex items-center gap-4">
                            <MessageSquare className="h-6 w-6 text-primary" />
                             <div>
                                <CardTitle className="font-headline text-2xl">Chat Moderation</CardTitle>
                                <CardDescription>Review chat logs for rule violations.</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent>
                        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed p-12 text-center h-[300px]">
                            ...
                            <p className="mt-2 text-muted-foreground">
                               The chat moderation tool is coming soon.
                            </p>
                        </div>
                    </CardContent>
                </Card>
