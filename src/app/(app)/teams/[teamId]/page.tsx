  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        <div className="h-48 md:h-64 bg-muted rounded-t-lg overflow-hidden">
             <Image
        ...
        <Card className="rounded-t-none">
            <CardHeader className="pt-16 md:pt-20 px-6 md:px-8 pb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-1 space-y-6">
            {team.videoUrl && (
                <Card>
                    <CardHeader>
                        <CardTitle className="font-headline text-lg flex items-center gap-2"><Youtube className="h-5 w-5" /> Vídeo de Presentación</CardTitle>
                    </CardHeader>
                    <CardContent>
