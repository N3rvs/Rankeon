    ...
    <div className="w-full min-h-screen lg:grid lg:grid-cols-2">
       <div className="relative hidden flex-col items-center justify-center bg-gray-900 text-white lg:flex">
        <Image 
            ...
            data-ai-hint="esports team strategy"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-background via-background/50 to-transparent" />
        <div className="relative z-10 text-center max-w-sm">
            <h1 className="text-4xl font-bold font-headline">Construye tu legado.</h1>
            <p className="text-lg text-white/80 mt-2">Registra tu cuenta y empieza a forjar tu equipo de campeones.</p>
        </div>
      </div>
