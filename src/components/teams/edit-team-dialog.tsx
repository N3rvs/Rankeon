        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4 pt-4 border-t">
                <h3 className="text-sm font-medium text-muted-foreground">Redes Sociales & Enlaces</h3>
                 <FormField
                  control={form.control}
                  name="discordUrl"
                  render={({ field }) => (
                ...
                />
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="flex items-center gap-2"><Youtube className="h-5 w-5" /> Vídeo de Presentación (YouTube)</FormLabel>
