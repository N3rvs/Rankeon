...
export const createTaskV2 = onCall({ region: 'europe-west1' }, async (req: any) => {
...
export const listMyTasks = onCall({ region: 'europe-west1' }, async (req: any) => {
    const uid = assertAuth(req);
...
export const updateTaskV2 = onCall({ region: 'europe-west1' }, async (req: any) => {
    const uid = assertAuth(req);
...
export const addSubtask = onCall({ region: 'europe-west1' }, async (req: any) => {
  const uid = assertAuth(req);
...
export const toggleSubtask = onCall({ region: 'europe-west1' }, async (req: any) => {
  // Implementation for toggling a subtask
});
