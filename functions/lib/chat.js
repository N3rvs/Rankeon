...
exports.getChats = (0, https_1.onCall)(async ({ auth }) => {
    if (!auth)
    ...
    try {
        ...
        const chats = chatsSnap.docs.map(doc => {
            var _a, _b;
            const data = doc.data();
            return Object.assign(Object.assign({ id: doc.id }, data), { lastMessageAt: ((_a = data.lastMessageAt) === null || _a === void 0 ? void 0 : _a.toDate().toISOString()) || null, createdAt: ((_b = data.createdAt) === null || _b === void 0 ? void 0 : _b.toDate().toISOString()) || null });
        });
        return chats;
    }
    catch (error) {
