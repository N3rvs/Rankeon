...
exports.userListFriends = void 0;
...
exports.userListFriends = (0, https_1.onCall)({ region: "europe-west1", enforceAppCheck: true }, async (req) => {
    if (!req.auth)
...
//# sourceMappingURL=userListFriends.js.map